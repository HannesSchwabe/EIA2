namespace L07_AssocArraysAndExport {
	...
	export let data: HomogenousArray
		...
		"Toppings": [
			{ type: "checkbox", id: "check1.1", name: "Smarties", value: "0", step: "", min: "", max: "", class: "", call: "Smarties", alt: "0.50" },
			{ type: "checkbox", id: "check1.1", name: "Streußel", value: "0", step: "", min: "", max: "", class: "", call: "Streußel", alt: "0.50" },
			{ type: "checkbox", id: "check1.1", name: "Schoko-Sauce", value: "0", step: "", min: "", max: "", class: "", call: "Schoko-Sauce", alt: "0.50" },
