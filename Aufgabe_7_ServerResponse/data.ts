namespace L07_AssocArraysAndExport {
	...
	export let data: HomogenousArray
		= {
		"Optionen": [
			{ type:"radio", id: "radio1", name: "Becher/Waffel", value: "0", step: "", min: "", max: "", class: "Becher", call: "Becher", alt: "0.50"},
			{ type: "radio", id: "radio2", name: "Becher/Waffel", value: "0", step: "", min: "", max: "", class: "Waffel", call: "Waffel", alt: "0.50" }
		],
		"Eissorten": [
		...
		"Toppings": [
			{ type: "checkbox", id: "check1.1", name: "Smarties", value: "0", step: "", min: "", max: "", class: "Smarties", call: "Smarties", alt: "0.50" },
			{ type: "checkbox", id: "check1.1", name: "Streußel", value: "0", step: "", min: "", max: "", class: "Streußel", call: "Streußel", alt: "0.50" },
			{ type: "checkbox", id: "check1.1", name: "Schoko-Sauce", value: "0", step: "", min: "", max: "", class: "Schoko-Sauce", call: "Schoko-Sauce", alt: "0.50" },
			{ type: "checkbox", id: "check1.1", name: "Mandeln", value: "0", step: "", min: "", max: "", class: "Mandeln", call: "Mandeln", alt: "0.50" }
		]
	};
}