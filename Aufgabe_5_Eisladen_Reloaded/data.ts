namespace L04_AssocArraysAndExport {
	...
	export let data: HomogenousArray
		...
		"Eissorten": [
			{ type: "number", id: "0", name: "Stepper", value: "0", step: "1", min: "0", max: "5",  class: "Maracuja", call: "Maracuja", alt: "1"},
            { type: "number", id: "0", name: "Stepper", value: "0", step: "1", min: "0", max: "5",  class: "Schokolade", call: "Schokolade", alt: "1" },
            { type: "number", id: "0", name: "Stepper", value: "0", step: "1", min: "0", max: "5",  class: "Zitrone", call: "Zitrone", alt: "1" },
            { type: "number", id: "0", name: "Stepper", value: "0", step: "1", min: "0", max: "5",  class: "Vanille", call: "Vanille", alt: "1" },
            { type: "number", id: "0", name: "Stepper", value: "0", step: "1", min: "0", max: "5",  class: "Pistazie", call: "Pistazie", alt: "1" },
            { type: "number", id: "0", name: "Stepper", value: "0", step: "1", min: "0", max: "5",  class: "Joghurt", call: "Joghurt", alt: "1" },
		],
		"Toppings": [
